...
if not INSTITUTIONAL_ONLY:
    ...
    register_users_module(ui, {'app': app, 'ensure_platform_access': ensure_platform_access, 'shell': shell, 'fix_text': fix_text, 'obtener_usuarios': obtener_usuarios, 'crear_usuario': guarded_crear_usuario, 'actualizar_usuario': guarded_actualizar_usuario, 'eliminar_usuario': guarded_eliminar_usuario, 'obtener_empresas': obtener_empresas, 'list_modules_catalog': list_modules_catalog, 'get_available_modules_for_company': get_available_modules_for_company, 'get_enabled_modules_for_user': get_enabled_modules_for_user, 'assign_modules_to_user': assign_modules_to_user, 'guardar_legal_matrix_delete_password': guardar_legal_matrix_delete_password, 'tiene_legal_matrix_password_personalizada': tiene_legal_matrix_password_personalizada, 'obtener_legal_matrix_alert_settings': obtener_legal_matrix_alert_settings, 'guardar_legal_matrix_alert_settings': guardar_legal_matrix_alert_settings, 'obtener_legal_matrix_role': obtener_legal_matrix_role, 'asignar_legal_matrix_role': asignar_legal_matrix_role, 'MATRIX_ROLES': MATRIX_ROLES})
