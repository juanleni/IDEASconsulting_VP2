...
# 2026-08-28: capa de servicios de Calidad/8D extraida a quality_service.py
# (mismo patron que legal_matrix_service.py, Fase 4). Se re-exportan estos
# nombres para que el resto del codigo (modules_quality.py, app.py) siga
# funcionando sin cambios con `from core_data import obtener_..._calidad...`
# -- son el mismo objeto de funcion, asi que `_clear_caches()` mas abajo
# tambien los sigue invalidando igual que antes.
from quality_service import (  # noqa: E402
    actualizar_problema_calidad_8d,
    crear_problema_calidad_8d,
    eliminar_5_porque_problema_calidad,
    eliminar_accion_8d,
    eliminar_ishikawa_problema_calidad,
