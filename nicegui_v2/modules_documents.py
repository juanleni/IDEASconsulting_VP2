...
def go_to_company_documents_module(company_id: int | None = None, set_selection_fn=None) -> None:
    ...
    ui.navigate.to(with_empresa_id('/sistema-gestion/documentos/empresa', company_id))
                ...
                if company_map and str(app.storage.user.get('role') or '') == 'admin':
                    ...
                    company_select.on_value_change(
                        lambda _e: (
                            ...
                            ui.navigate.to(with_empresa_id('/sistema-gestion/documentos/empresa', company_select.value)),
                        )
                    )
                if selected_company:
